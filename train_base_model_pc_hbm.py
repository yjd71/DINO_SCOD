...
def parse_args() -> argparse.Namespace:
    ...
    migration.add_argument(
        ...
        action="store_true",
        help=(
            "Explicitly migrate a V2 parent-conditioned Decoder to V3; "
            "retain non-verifier weights, W32, and verification strength only."
        ),
    )
...
def validate_training_args(args: argparse.Namespace) -> None:
    ...
    if args.init_pcv_from_v2 and not args.decoder_checkpoint:
        raise ValueError("--init-pcv-from-v2 requires --decoder-checkpoint")
    ...
    try:
        ...
        if args.resume:
            ...
            pc_cfg = read_pc_config(
                ...
                init_pcv_from_v2=args.init_pcv_from_v2,
            )
        else:
